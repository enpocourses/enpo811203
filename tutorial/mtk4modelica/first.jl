...
# ╔═╡ 3e4ac5eb-e18e-4a97-bf9c-84d7a42d0d18
begin
...
# ╔═╡ 9c65f452-3af1-4030-af9b-771507fb9d11
begin
	using DifferentialEquations: solve
	using Plots: plot
end

# ╔═╡ 31608960-cf7b-11ec-12c3-1724450634b4
md"我们这几开始了啊"

# ╔═╡ 8027996c-e684-4918-8a28-666e116efc8c
@variables x(t)

# ╔═╡ 70a40d05-4fc8-4ff7-98e0-d60829c14db9
@named firstorder = ODESystem([D(x)~1-x])

# ╔═╡ d24df8e2-63ef-4f0a-a2c2-4bff69110716
begin
	prob = ODEProblem(firstorder, [x => 0.0], (0.0,10.0), [])
	sol = solve(prob)
end

# ╔═╡ 0d807c01-65f0-4cae-9e4a-9a4c4a8082a4
plot(sol, vars=[x])

# ╔═╡ 7286870f-6336-4c69-b194-ef90bc3cee22
function MyfirstOrder(;name)
	@parameters t
	D=Differential(t)
	@variables x(t)
	eqs=[D(x)~1-x]
...
# ╔═╡ dc063a0d-991c-442d-ab4e-5d7f28fc4ace
@named myfirstorder = MyfirstOrder()

# ╔═╡ 0f5e7bb7-548b-4077-8d54-f8cc4bd5f989
begin
	prob2 = ODEProblem(myfirstorder, [x => 0.2], (0.0,10.0), [])
	sol2 = solve(prob2)
end

# ╔═╡ 62678d77-4a98-4c69-b0d6-871aa68cb92f
plot(sol2, vars=[x])
...
git-tree-sha1 = "7cc038a59f9d5804b3607ed89768e8b1c6cfdfe9"
